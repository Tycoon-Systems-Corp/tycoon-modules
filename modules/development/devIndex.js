...
The easiest way to manipulate the order of the dropdown menu is using the JSX in this file.`,code:`import { Account, GoLive, Help, Feedback } from '@tycoonsystems/tycoon-modules/menu/parts'
